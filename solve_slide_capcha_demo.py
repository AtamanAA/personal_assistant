...
class SlideCapchaSolveDemo:
    ...
    def move_slider(self, cx, cy):
        ...
        self.driver.save_screenshot(f"{BASE_DIR}/screenshots/mouse_move_step_1.png")
        time.sleep(5)
        ...
        action.move_by_offset(x_position, 5).perform()
        time.sleep(5)
        print("Mouse move. Step 2")
    ...
    def start_solve(self):
        ...
        self._solve_captcha()
        time.sleep(5)
        self.driver.save_screenshot(f"{BASE_DIR}/screenshots/success_solve_slide_capcha.png")
        time.sleep(5)
        self.driver.quit()
